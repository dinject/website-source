...
<@smallnav activeCheck="${post!''}" url="/docs/javalin/post" title="@Post + @Form">
  <ul>
...
<@smallnav activeCheck="${put!''}" url="/docs/javalin/put" title="@Put"/>
<@smallnav activeCheck="${patch!''}" url="/docs/javalin/patch" title="@Patch"/>
<@smallnav activeCheck="${delete!''}" url="/docs/javalin/delete" title="@Delete"/>
...
<@smallnav activeCheck="${jaxrs!''}" url="/docs/javalin/jaxrs" title="JAX-RS Comparison"/>
